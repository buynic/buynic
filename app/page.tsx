      ...
      <section className="px-4 sm:px-6 lg:px-8 py-6 md:py-10 max-w-[1400px] mx-auto">
        ...
        <RevealOnScroll>
          <div className="text-center max-w-3xl mx-auto mb-10 md:mb-14 relative">
            <h1 className="text-4xl md:text-5xl lg:text-6xl font-medium tracking-tight text-foreground leading-[1.2] mb-4">
              Curated Essentials <br className="hidden md:block" />
              <span className="text-muted-foreground italic">for Modern Living</span>
            </h1>
        ...
        <div className="grid grid-cols-1 md:grid-cols-12 gap-4 md:gap-6 auto-rows-[160px] md:auto-rows-[120px]">
          ...
          <div className="col-span-12 md:col-span-6 lg:col-span-3 row-span-4">
            <RevealOnScroll delay={100} className="h-full">
              <div className="bg-[#F5E6D3] dark:bg-stone-800 rounded-[2rem] relative group overflow-hidden shadow-sm transition-all hover:shadow-xl h-full">
                <img
                  src="https://images.unsplash.com/photo-1505740420928-5e560c06d30e?auto=format&fit=crop&q=80&w=800"
                  alt="Premium Headphones"
                  className="object-cover h-full w-full transition-transform duration-700 group-hover:scale-105 opacity-90 dark:opacity-75"
                />
          ...
          <div className="col-span-12 md:col-span-6 lg:col-span-3 row-span-4">
            <RevealOnScroll delay={200} className="h-full">
              <div className="bg-[#E8F5E9] dark:bg-stone-800 rounded-[2rem] relative group overflow-hidden shadow-sm transition-all hover:shadow-xl h-full">
                <img
          ...
          <div className="col-span-12 md:col-span-6 lg:col-span-3 row-span-4 flex flex-col gap-4 md:gap-6">
            ...
            <RevealOnScroll delay={300} className="flex-1 h-full min-h-0">
              <div className="bg-[#FFF3E0] dark:bg-stone-800 rounded-[2rem] relative group overflow-hidden shadow-sm transition-all hover:shadow-xl h-full">
                <img
          ...
          <div className="col-span-12 md:col-span-6 lg:col-span-3 row-span-4">
            <RevealOnScroll delay={500} className="h-full">
              <div className="bg-[#E3F2FD] dark:bg-stone-800 rounded-[2rem] relative group overflow-hidden shadow-sm transition-all hover:shadow-xl h-full">
                <img
          ...
          <div className="col-span-12 md:col-span-6 lg:col-span-6 row-span-2">
            <RevealOnScroll delay={600} className="h-full">
              <div className="bg-[#FCE4EC] dark:bg-stone-800 rounded-[2rem] relative group overflow-hidden shadow-sm transition-all hover:shadow-xl h-full">
                <img
          ...
          <div className="col-span-12 md:col-span-6 lg:col-span-6 row-span-2">
            <RevealOnScroll delay={700} className="h-full">
              <div className="bg-gray-50 dark:bg-stone-800 rounded-[2rem] relative group overflow-hidden shadow-sm transition-all hover:shadow-xl h-full">
                <img
      ...
      <section className="bg-background py-12 md:py-16 border-t border-border">
        <div className="mx-auto max-w-7xl px-6 lg:px-8">
          <div className="mb-12 text-center">
            ...
            <p className="mt-4 text-muted-foreground">Selection of our most popular items.</p>
          </div>
