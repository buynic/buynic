...
Privacy Policy — Buynic

Last Updated: ${new Date().toLocaleDateString()}

Welcome to Buynic (“we”, “our”, “us”). Your privacy is important to us. This Privacy Policy explains how we collect, use, store, and protect your information when you use buynic.shop.

1. Information We Collect

When using Buynic, we may collect the following information:
...
Buynic uses secure Google Sign-In authentication via Supabase.
We do not store passwords directly on our servers.
...
Incorrect details may result in delivery failure or order cancellation.
...
Buynic is not intended for users under 18 years of age.

10. Policy Updates

We may update this policy periodically. Continued use of Buynic means acceptance of updated terms.
...
Terms of Service — Buynic

Last Updated: ${new Date().toLocaleDateString()}

By accessing or using buynic.shop, you agree to the following terms.
...
(This clause is VERY important legally.)
...
(This protects you from fake orders.)
...
All website content including branding, design, and layout belongs to Buynic and may not be copied without permission.

11. Modifications

We may update services or policies at any time. Continued usage implies acceptance.
